...
To install the development version of \Biocpkg{EGSEA} from Bioconductor, run the
...
To install the development version of \Biocpkg{EGSEA} from Bitbucket, type in the R
console
...
The stable release version of \Biocpkg{EGSEA} can be from Bitbucket by setting
\Rcode{ref = "Stabel\_Release"} in the previous commands.
...
\begin{figure}[!h]
\center
\includegraphics[width=0.6\paperwidth]{X24IL13-X24-kegg-methods.pdf}
...
\centering
\includegraphics[width=\linewidth]{{X24IL13-X24-kegg-summary.dir}.pdf}
\caption{\label{fig:kegg_summary_dir} Directional summary plot}
\end{subfigure}
\begin{subfigure}{.5\textwidth}
\centering
\includegraphics[width=\linewidth]{{X24IL13-X24-kegg-summary.rank}.pdf}
...
\begin{figure}[!h]
\center
\includegraphics[width=0.8\paperwidth]{X24IL13-X24-c5-top-BP.pdf}
...
\begin{figure}[!h]
\center
\includegraphics[width=0.6\paperwidth]{asthma_hm.pdf}
...
\begin{figure}[!h]
\center
\includegraphics[width=0.8\paperwidth]{asthma_pathway.png}
...
\begin{figure}[!h]
\center
\includegraphics[width=0.6\paperwidth]{{kegg-summary-cmp.dir}.pdf}
...
the IL-13 antagonist in neuteralizing most of the IL-13 stimulated pathways. To
closely see how this happens, a comparative heatmap can be generated as follows 
...
\begin{figure}[!h]
\center
\includegraphics[width=0.6\paperwidth]{asthma_hm_cmp.pdf}
...
\begin{figure}[!h]
\center
\includegraphics[width=0.8\paperwidth]{asthma_pathway_cmp.png}
